  ...
  return (
    <div className="page-shell">
      <Card>
        ...
        <p>Upload your mapping, optional template, and data files to produce a standardized Excel output.</p>
        <form onSubmit={handleSubmit}>
          ...
          <div className="section">
            <Label htmlFor="data">Input files (CSV or Excel, one or more)</Label>
            <Input
              id="data"
              type="file"
              multiple
            ...
            />
            <div className="files-hint">We will merge and normalize all provided files.</div>
          </div>
